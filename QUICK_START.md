# 🚀 Quick Start Guide - Testes e CI/CD
...
1. **Testes rápidos**: Use `bash scripts/run-tests.sh quick` enquanto desenvolve
2. **Debug**: Use `--pdb` para parar em breakpoints
3. **Coverage**: Mantenha > 80% sempre
4. **CI**: Não faça merge se CI falhar
5. **Commits**: Faça commits pequenos e frequentes

## 🎉 Pronto!

Agora você tem:
- ✅ Testes locais que rodam automaticamente
- ✅ Pre-commit hooks para validar antes de commitar
- ✅ GitHub Actions para validar no servidor
- ✅ Coverage reports para monitorar qualidade
- ✅ Scripts para facilitar workflow
